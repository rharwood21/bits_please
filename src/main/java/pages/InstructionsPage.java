...
/**
 * The pages.InstructionsPage class represents the GUI page that displays the
 * instructions for the Trivial Compute Game.
 * It provides information on how to play the game and navigate through
 * different stages.
 */
public class InstructionsPage extends JFrame {
   ...
   public InstructionsPage(GameController controller) {
      ...
      // TODO undo hardcode
      JTextArea objectText = setTextArea(
            "The objective of Trivial Compute is to correctly answer questions from four selected categories. " +
      ...
      JTextArea setupText = setTextArea(
            "To start the game, players choose the four unique categories of questions and assign colors to each category. "
                  +
